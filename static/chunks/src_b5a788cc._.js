                ...
                "DashboardPage.useCallback[loadScheduleForTeacherAndWeek]": ([day, daySessions])=>{
                    daySessions.forEach({
                        "DashboardPage.useCallback[loadScheduleForTeacherAndWeek]": (session)=>{
                            ...
                            if (period.toLowerCase().startsWith('p') && hour !== 12) hour += 12;
                            if (period.toLowerCase().startsWith('a') && hour === 12) hour = 0;
                            newSessions.push({
                                ...session,
                                day,
                                startRow: hour
...
_s(DashboardPage, "8dGva9axlW2KxDPHj7ySHWazEL0=", false, function() {
    return [
...
//# sourceMappingURL=src_b5a788cc._.js.map