...
async function seedInitialData() {
    try {
        const collectionsToSeed = [
            {
                name: "users",
                initialData: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialUsers"],
                checkField: "username"
            },
            {
                name: "semesters",
                initialData: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialSemesters"],
                checkField: "name"
            },
            {
                name: "students",
                initialData: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialStudents"],
                checkField: "name"
            },
            {
                name: "requests",
                initialData: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialRequests"],
                checkField: "type"
            }
        ];
        for (const { name, initialData } of collectionsToSeed){
            ...
            const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(collRef);
            if (snapshot.empty) {
...
function DatabaseProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DatabaseProvider.useEffect": ()=>{
            ...
            const unsubSemesters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'semesters'), {
                "DatabaseProvider.useEffect.unsubSemesters": (snapshot)=>{
                    const allSemesters = snapshot.docs.map({
                        "DatabaseProvider.useEffect.unsubSemesters.allSemesters": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["DatabaseProvider.useEffect.unsubSemesters.allSemesters"]).sort({
                        "DatabaseProvider.useEffect.unsubSemesters.allSemesters": (a, b)=>new Date(b.startDate).getTime() - new Date(a.startDate).getTime()
                    }["DatabaseProvider.useEffect.unsubSemesters.allSemesters"]);
                    setSemesters(allSemesters);
                    setLoading(false);
                }
            }["DatabaseProvider.useEffect.unsubSemesters"], {
                "DatabaseProvider.useEffect.unsubSemesters": (error)=>{
    ...
    const addSemester = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseProvider.useCallback[addSemester]": async (semesterData)=>{
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(newSemesterRef, newSemester);
                toast({
    ...
    const updateSemester = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseProvider.useCallback[updateSemester]": async (semesterId, semesterData)=>{
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(semesterRef, semesterData);
                toast({
...
_s(DatabaseProvider, "OCXbBPFdE9xvOcsiFtOxzxQZUmo=", false, function() {
    return [
...
//# sourceMappingURL=src_ba6badcb._.js.map