    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        ...
        children: navItems.map((item)=>userHasRole(item.roles) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("group flex items-center rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground", pathname === item.href ? "bg-accent" : "transparent"),
                    children: [
...
function UserNav() {
    _s();
    const { user, logout, switchRole } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    if (!user) {
        return null;
    }
...
_s(UserNav, "06CtBsvU/icOlXXgfEPRp8cTJz0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.esm2017.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/auth-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/data.ts [app-client] (ecmascript)"); // For initial structure, will be replaced by Firestore data
;
...
async function seedInitialData() {
    const { setDoc, doc, getDocs } = await __turbopack_context__.r("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
    try {
        console.log("Checking and seeding initial data to Firestore...");
        // Seed Semesters
        const initialSemesters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialSemesters"])();
        ...
        if (semesterSnapshot.empty) {
            ...
            for (const semester of initialSemesters){
                await setDoc(doc(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "semesters", semester.id), semester);
            }
        }
        // Seed Students
        const initialStudents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialStudents"])();
        ...
        if (studentSnapshot.empty) {
            ...
            for (const student of initialStudents){
                await setDoc(doc(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "students", student.id), student);
            }
        }
...
function DatabaseProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DatabaseProvider.useEffect": ()=>{
            ...
            setLoading(true);
            const unsubscribeSemesters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'semesters'), {
                "DatabaseProvider.useEffect.unsubscribeSemesters": (snapshot)=>{
                    const allSemesters = snapshot.docs.map({
                        "DatabaseProvider.useEffect.unsubscribeSemesters.allSemesters": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["DatabaseProvider.useEffect.unsubscribeSemesters.allSemesters"]);
                    setSemesters(allSemesters);
                    // We can turn off the main loading indicator once semesters are loaded
                    setLoading(false);
                }
            }["DatabaseProvider.useEffect.unsubscribeSemesters"], {
                "DatabaseProvider.useEffect.unsubscribeSemesters": (error)=>{
                    console.error("Error fetching semesters: ", error);
                    setLoading(false);
                }
            }["DatabaseProvider.useEffect.unsubscribeSemesters"]);
            const unsubscribeStudents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'students'), {
                "DatabaseProvider.useEffect.unsubscribeStudents": (snapshot)=>{
                    const allStudents = snapshot.docs.map({
                        "DatabaseProvider.useEffect.unsubscribeStudents.allStudents": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["DatabaseProvider.useEffect.unsubscribeStudents.allStudents"]);
                    setStudents(allStudents);
                }
            }["DatabaseProvider.useEffect.unsubscribeStudents"], {
                "DatabaseProvider.useEffect.unsubscribeStudents": (error)=>{
...
_s(DatabaseProvider, "ttgaa+a/DYLbi2jz967gP9OVMA8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_f7bf0f7f._.js.map