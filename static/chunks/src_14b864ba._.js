...
const getInitialSemesters = ()=>{
    ...
    const createSessionStudents = (teacher, sessionId)=>{
        return students.filter((s)=>s.enrolledIn.some((e)=>e.teacher === teacher && e.sessionId === sessionId)).map((s)=>({
                id: s.id,
                name: s.name,
                attendance: null,
                    ...
                    "Saturday": [
                        {
                            ...
                            "students": createSessionStudents("نهاد", "Saturday-13"),
                            "duration": 2,
                            "specialization": "عود",
                            "type": "practical"
                        },
                        {
                            ...
                            "students": createSessionStudents("نهاد", "Saturday-15"),
                            "duration": 2,
                            "specialization": "عود",
                            "type": "practical"
                        }
                    ...
                    "Sunday": [
                        {
                            ...
                            "students": createSessionStudents("حازم", "Sunday-14"),
                            "duration": 1,
                            "specialization": "عود",
                            "type": "practical"
                        },
                        {
                            ...
                            "students": createSessionStudents("حازم", "Sunday-16"),
                            "duration": 1,
                            "specialization": "عود",
                            "type": "practical"
                        }
                    ...
                    "Monday": [
                        {
                            ...
                            "students": createSessionStudents("هاني", "Monday-17"),
                            "duration": 1,
                            "specialization": "ناي",
                            "type": "practical"
                        }
                    ...
                    "Tuesday": [
                        {
                            ...
                            "students": createSessionStudents("بسام", "Tuesday-18"),
                            "duration": 1,
                    ...
                    "Wednesday": [
                        {
                            "id": "Wednesday-16",
                            "time": "4:00 PM - 5:00 PM",
                            "students": createSessionStudents("يعرب", "Wednesday-16"),
                            "duration": 1,
                            "specialization": "صناعة العود",
                            "type": "practical"
                        }
                    ]
                }
...
function AuthProvider({ children }) {
    ...
    const [users] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialUsers"])());
...
_s1(AuthProvider, "rHQpfBD6oSicPKGekQ/bTppRdQU=", false, function() {
    return [
...
//# sourceMappingURL=src_14b864ba._.js.map