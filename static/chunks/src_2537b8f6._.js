...
_s(UserNav, "R7+hN4zlAzl3zjygOmBm7ohpBLs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
function useLocalStorage(key, initialValue) {
    ...
    const setValue = (value)=>{
        try {
            ...
            Object.values(listenersRef.current).forEach((listener)=>listener(valueToStore));
        } catch (error) {
            console.log(error);
        }
    };
    ...
    // This effect ensures components re-render if the storage is updated from another tab/window.
                ...
                "useLocalStorage.useEffect.handleStorageChange": (event)=>{
                    if (event.key === key && event.newValue) {
                        ...
                        Object.values(listenersRef.current).forEach({
                            "useLocalStorage.useEffect.handleStorageChange": (listener)=>listener(newValue)
...
_s(useLocalStorage, "2eizjkooBnewSU/Upif65N4OQJ8=");
...
_s1(DatabaseProvider, "PMbZSIk2rQOtA/F87/W68gmfUMI=", false, function() {
    return [
        useLocalStorage,
        useLocalStorage,
        useLocalStorage,
...
//# sourceMappingURL=src_2537b8f6._.js.map